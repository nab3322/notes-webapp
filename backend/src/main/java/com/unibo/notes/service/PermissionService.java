...
public class PermissionService {
    ...
    public boolean hasReadPermission(Long noteId, Long userId) {
        Note note = noteRepository.findByIdOptional(noteId)
    ...
    public List<Note> getSharedNotes(Long userId) {
        List<NotePermission> permissions = permissionRepository.findByUserId(userId);
    ...
    private PermissionDTO toDTO(NotePermission permission) {
        ...
        dto.permission = permission.permission.name();
